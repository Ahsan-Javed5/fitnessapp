...
import 'package:fitnessapp/screens/signup/coach/signup_coach_menu_page.dart'
    as menu_item;
import 'package:fitnessapp/screens/signup/sign_up_coach.dart';
...
class SignUpCoachHomeScreen extends StatefulWidget {
  const SignUpCoachHomeScreen({Key? key}) : super(key: key);

  @override
  _SignUpCoachHomeScreenState createState() => _SignUpCoachHomeScreenState();
}

class _SignUpCoachHomeScreenState extends State<SignUpCoachHomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return ZoomDrawer(
      ...
      menuScreen: menu_item.SignUpCoachMenuScreen(
        getMenuListing()!,
  ...
  Widget build(BuildContext context) {
    ...
    GetPageRoute? onGenerateRoute(RouteSettings settings) {
      switch (settings.name) {
        case NestedRoutesName.signUpCoach:
          return GetPageRoute(
            settings: settings,
            page: () => SignUpCoach(callback: onClicked),
          );
      }
      return null;
    }
            ...
            child: GradientBackground(
              ...
              child: Scaffold(
                ...
                body: Navigator(
                  ...
                  initialRoute: NestedRoutesName.signUpCoach,
...
class SignUpCoachMenuProvider extends ChangeNotifier {
  int _currentPage = 0;
