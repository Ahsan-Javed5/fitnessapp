...
import 'signup_user_side_menu_home_screen.dart';

class SignUpUserMenuScreen extends StatefulWidget {
  final List<MenuItem> mainMenu;
  final Function(int)? callback;
  final int? current;

  const SignUpUserMenuScreen(
    this.mainMenu, {
    Key? key,
    this.callback,
    this.current,
  ...
  @override
  _SignUpUserMenuScreenState createState() => _SignUpUserMenuScreenState();
}

class _SignUpUserMenuScreenState extends State<SignUpUserMenuScreen> {
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Spaces.y4,
                    Expanded(
                      child: Selector<SignUpUserMenuProvider, int>(
